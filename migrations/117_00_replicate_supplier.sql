...
INSERT 
	...
	insert into Usersettings.ClientsData(FirmCode, FirmStatus, BillingCode, RegionCode, MaskRegion, FullName, ShortName, ContactGroupOwnerId)
	select NEW.Id, New.Disabled = 0, NEW.Payer, NEW.HomeRegion, NEW.RegionMask, NEW.FullName, NEW.Name, NEW.ContactGroupOwnerId;
END;
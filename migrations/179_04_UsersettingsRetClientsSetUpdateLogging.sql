...
add column NetworkSupplierId int(10) unsigned,
add column NoiseCosts tinyint(1),
add column NoiseCostExceptSupplierId int(10) unsigned,
add column NetworkPriceId int(10) unsigned,
add column AssortimentPriceId int(10) unsigned,
add column OfferMatrixPriceId int(10) unsigned,
add column OfferMatrixType int(10) unsigned
;

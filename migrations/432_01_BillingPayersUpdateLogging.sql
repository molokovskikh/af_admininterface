...
add column PaymentSum decimal(19,5),
add column RegistrationDate datetime,
add column Registrant varchar(255),
add column SendToMinimail tinyint(1)
;
...
FOR EACH ROW BEGIN
	...
	SET LogTime = now(),
		...
		PaymentSum = NULLIF(NEW.PaymentSum, OLD.PaymentSum),

DROP PROCEDURE Future.GetActivePricesForAddress;
CREATE DEFINER=`RootDBMS`@`127.0.0.1` PROCEDURE Customers.`GetActivePricesForAddress`(IN UserIdParam INT UNSIGNED, IN AddressIdParam INT UNSIGNED)
BEGIN

DROP PROCEDURE Future.GetPricesForAddress;
CREATE DEFINER=`RootDBMS`@`127.0.0.1` PROCEDURE Customers.`GetPricesForAddress`(IN UserIdParam INT UNSIGNED, IN AddressIdParam INT UNSIGNED)
BEGIN

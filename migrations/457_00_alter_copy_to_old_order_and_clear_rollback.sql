...
CREATE DEFINER=`RPA`@`rpa.adc.analit.net` EVENT Orders.`copyToOldOrdersAndClear` ON SCHEDULE EVERY 1 DAY STARTS '2010-08-11 00:01:00' ON COMPLETION PRESERVE ENABLE DO BEGIN

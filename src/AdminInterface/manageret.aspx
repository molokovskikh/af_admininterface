                                    ...
                                    <font face="Arial" size="2">
                                        <div>
                                            <asp:CheckBox ID="InvisibleCB" runat="server" Font-Names="Verdana" Font-Size="8pt"
                                                Text="&#34;Невидимый&#34; клиент" BorderStyle="None"></asp:CheckBox></div>
                                    </font>
                                </td>
                            </tr>
                            <tr>
                                    ...
                                    <font face="Arial" size="2">
                                        <div>
                                            <asp:CheckBox ID="RejectsCB" runat="server" Font-Names="Verdana" Font-Size="8pt"
                                                Text="Забраковка"></asp:CheckBox></div>
                                    </font>
                                </td>
                            </tr>
                            <tr>
                                <td valign="middle" align="left" colspan="3">
                                    <font face="Arial" size="2">
                                        <div>
                                            <asp:CheckBox ID="DocumentsCB" runat="server" Font-Names="Verdana" Font-Size="8pt"
                                                Text="Документы" Enabled="False"></asp:CheckBox></div>
                                    </font>
                                </td>
                                <tr>
                                    <td valign="middle" align="left" colspan="3">
                                        ...
                                        <font face="Arial" size="2">
                                            <div>
                                                <asp:CheckBox ID="AdvertisingLevelCB" runat="server" Font-Names="Verdana" Font-Size="8pt"
                                                    Text="Реклама" BorderStyle="None"></asp:CheckBox></div>
                                        </font>
                                    </td>
                                </tr>
                                <tr>
                                        ...
                                        <font face="Arial" size="2">
                                            <div>
                                                <asp:CheckBox ID="WayBillCB" runat="server" Font-Names="Verdana" Font-Size="8pt"
                                                    Text="Накладные" BorderStyle="None" Enabled="False"></asp:CheckBox></div>
                                        </font>
                                    </td>
                                </tr>
                                <tr>
                                        ...
                                        <font face="Arial" size="2">
                                            <div>
                                                <asp:CheckBox ID="ChangeSegmentCB" runat="server" Font-Names="Verdana" Font-Size="8pt"
                                                    Text="Изменение сегмента" BorderStyle="None"></asp:CheckBox></div>
                                        </font>
                                    </td>
                                </tr>
                                <tr>
                                        ...
                                        <font face="Arial" size="2">
                                            <div>
                                                <asp:CheckBox ID="EnableUpdateCB" runat="server" Font-Names="Verdana" Font-Size="8pt"
                                                    Text="Автоматическое обновление версий" BorderStyle="None"></asp:CheckBox></div>
                                        </font>
                                    </td>
                                </tr>
                                <tr>
                                    <td style="height: 12px" valign="middle" align="left" colspan="3">
                                        <asp:CheckBox ID="CheckCopyIDCB" runat="server" Font-Names="Verdana" Font-Size="8pt"
                                            Text="Проверять уникальный идентификатор" BorderStyle="None" Enabled="False"></asp:CheckBox></td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    <td style="height: 8px" valign="middle" align="left" colspan="3">
                                        ...
                                        <asp:DropDownList ID="RegionDD" runat="server" OnSelectedIndexChanged="RegionDD_SelectedIndexChanged" Font-Names="Verdana" Font-Size="8pt"
                                            AutoPostBack="True" DataSource="<%# admin %>" DataTextField="Region" DataValueField="RegionCode">
                                        </asp:DropDownList>
                                        <asp:CheckBox ID="AllRegCB" runat="server" OnCheckedChanged="AllRegCB_CheckedChanged" Font-Size="8pt" Font-Names="Verdana" Text="Показать все регионы"
                                ...
                                <tr>
                                    <td valign="middle" align="right" colspan="3" style="height: 17px">
                                        <asp:Button ID="ParametersSave" runat="server" OnClick="ParametersSave_Click" Font-Names="Verdana" Font-Size="8pt"
                                                ...
                                                <table id="Table5" cellspacing="0" cellpadding="0" width="300" border="0">
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <p align="right">
                                                                    <asp:Button ID="SendMessage" runat="server" OnClick="SendMessage_Click" Font-Names="Arial" Font-Size="10pt" Text="Отправить"

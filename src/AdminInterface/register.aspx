						...
						<div class="TwoColumn">
							<div class="SimpleField">
								...
								<asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" Font-Size="7pt"
									ControlToValidate="FullNameTB" ErrorMessage="Поле «Полное наименование» должно быть заполнено">*</asp:RequiredFieldValidator>
							</div>
							<div class="SimpleField">
								...
								<asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="ShortNameTB"
									ErrorMessage="Поле «Краткое наименование» должно быть заполнено">*</asp:RequiredFieldValidator>
							</div>
							<div class="SimpleField">
								...
								<asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server" ControlToValidate="AddressTB"
									ErrorMessage="Поле «Адрес» должно быть заполнено">*</asp:RequiredFieldValidator>
							</div>
							<div class="SimpleField">
								...
								<asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" Font-Size="7pt"
									ControlToValidate="PhoneTB" ErrorMessage="Поле «Телефон» должно быть заполнено">*</asp:RequiredFieldValidator>
							</div>
						</div>
						<div class="TwoColumn">
							<div class="SimpleField">
							...
							<div class="SimpleField">
								...
								<asp:RequiredFieldValidator ID="RequiredFieldValidator8" runat="server" ControlToValidate="EmailTB"
									ErrorMessage="Поле «E-mail» должно быть заполнено">*</asp:RequiredFieldValidator>
							</div>
							<div class="SimpleField">
								<label for="URLTB">
									URL:</label>
							...
							<div class="SimpleField">
								...
								<asp:RequiredFieldValidator ID="Requiredfieldvalidator4" runat="server" Font-Size="7pt"
									ControlToValidate="LoginTB" ErrorMessage="Поле «Login» должно быть заполнено">*</asp:RequiredFieldValidator>
							</div>
						</div>
					</div>
			...
			<tr valign="bottom" height="50">
				<td align="center" colspan="4" style="height: 50px">
					<asp:Button ID="Register" runat="server" OnClick="Register_Click" Font-Size="8pt"
						Font-Names="Verdana" Text="Зарегистрировать"></asp:Button><font face="Verdana" size="2"></font></td>
			</tr>
		</table>
	</form>
</body>

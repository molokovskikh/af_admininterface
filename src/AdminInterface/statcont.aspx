		...
		<p align="center">
			<asp:GridView ID="StatisticGrid" runat="server" AllowSorting="True" AutoGenerateColumns="False"
				...
				<Columns>
					...
					<asp:HyperLinkField DataTextField="Login" HeaderText="Пользователь" SortExpression="Login" DataNavigateUrlFields="UserId" DataNavigateUrlFormatString="users/{0}/edit" />
